...
public enum ModArmorTiers implements ArmorMaterial {
    ...
    NETHER_BRICKS("nether_bricks", ModMaterial.NETHER_BRICKS, SoundEvents.ARMOR_EQUIP_LEATHER, () -> Ingredient.of(Items.NETHER_BRICKS), new int[]{72, 77, 74, 61}),
    RED_NETHER_BRICKS("red_nether_bricks", ModMaterial.NETHER_BRICKS, SoundEvents.ARMOR_EQUIP_LEATHER, () -> Ingredient.of(Items.NETHER_BRICKS), new int[]{72, 77, 74, 61}),
